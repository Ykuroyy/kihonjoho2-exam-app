...
export const r5Questions: Question[] = [
  ...
  },
  {
    id: 'R5A003',
    category: 'A',
    text: `メモリインタリーブに関する記述として、適切なものはどれか。`,
    options: [
      'CPUの処理能力に合わせて、メモリの動作クロックを調整する方式である。',
      'プログラムの実行中に、使用頻度の高いデータをより高速なメモリに移す方式である。',
      '主記憶の見かけ上の容量を、補助記憶を用いて拡張する方式である。',
      '主記憶を複数の独立して動作するグループに分けて、各グループに並列にアクセスする方式である。'
    ],
    correctAnswer: 3,
